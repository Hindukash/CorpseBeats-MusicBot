module.exports = {
	...
	adminId: process.env.ADMIN_ID || "UserId", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.TOKEN || "", //- Bot's Token
	clientId: process.env.CLIENT_ID || "", //- ID of the bot
	clientSecret: process.env.CLIENT_SECRET || "", //- Client Secret of the bot
	port: parseInt(process.env.DASHBOARD_PORT) || 4200, //- Port of the API and Dashboard
	...
	nodes: [
		{
			...
			host: "lava-v3.ajieblogs.eu.org", //- Public Lavalink server with working YouTube
